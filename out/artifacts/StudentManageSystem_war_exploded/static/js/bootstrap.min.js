...
+function (a) {
    ...
    c.VERSION = "3.3.7", c.TRANSITION_DURATION = 600, c.DEFAULTS = {
        ...
        var e = this.$element.find(".item.active"), f = d || this.getItemForDirection(b, e),
            g = this.interval, h = "next" == b ? "left" : "right", i = this;
    ...
    b.VERSION = "3.3.7", b.DEFAULTS = {offset: 10}, b.prototype.getScrollHeight = function () {
        ...
        var a, b = this.$scrollElement.scrollTop() + this.options.offset,
            c = this.getScrollHeight(), d = this.options.offset + c - this.$scrollElement.height(),
